package com.choongang.frombirth;
...
public class FromBirthApplication implements CommandLineRunner {

    private static final Logger logger = LoggerFactory.getLogger(FromBirthApplication.class);

    // @Autowired
    // private JdbcTemplate jdbcTemplate; // JdbcTemplate을 자동으로 주입받기 위해 선언

    public static void main(String[] args) {
        SpringApplication.run(FromBirthApplication.class, args);
    }
